...
function NavBar(){
    return(
        ...
        <div style={{backgroundColor:'lavender',color:'#07588a',zIndex:10}}>
                  ...
                  <div className="collapse navbar-collapse  " id="navbarSupportedContent">
                    ...
                    <li className="nav-item">
                      {/* /*this link will show the Home page */}
                        <Link to='/' className="nav-link active me-4" style={{textDecoration:'none',color:'#07588a',fontSize:"20px"}}>Home</Link> 
                      </li>
                      <li className="nav-item">
                      {/* /*this link will show the Home page */}
